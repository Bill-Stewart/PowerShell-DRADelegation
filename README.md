...
(C) 2019-2021 by Bill Stewart (bstewart AT iname.com)
...
I wrote this module mainly because the EA.exe command-line interface is awkward and difficult to use. This module also adds a number of features missing from EA.exe.

## System Requirements

* DRA 9.2 or later
* DRA server installation including the **Command-line interface** feature
